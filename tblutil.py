...
arglen = len(sys.argv)
if arglen < 2:
    print('USAGE: TBLUTIL file1 [sheet=num] [col=alpha|num,alpha|num, ... alpha|num]')
    sys.exit()
...
# TODO Implement regular expressions to identify file extensions
if sys.argv[1].upper()[-3:] == 'XLS':
    # Excel
